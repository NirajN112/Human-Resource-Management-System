        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <a href="/" className="logo inline-flex items-center mb-4">
              <span className="text-2xl font-bold text-green-400">Human Resource Management System</span>
            </a>
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
           A Human Resource Management System (HRMS) streamlines employee management by digitizing essential HR processes such as employee onboarding, attendance tracking, leave management, payroll, and profile management. It enables employees and administrators to efficiently manage daily operations, improve productivity, and ensure accurate, secure, and organized workforce management.
            </p>
